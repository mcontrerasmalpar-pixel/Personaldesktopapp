...
export function LoginScreen({ onLogin }: Props) {
  ...
  return (
    <div style={{
      ...
      {/* Draw canvas — receives all events */}
      <canvas
        ref={canvasRef}
          ...
          <div style={{ background: "#C0C0C0", padding: 16 }}>
            <form onSubmit={handleSubmit}>
              ...
              <div style={{ marginBottom: 10 }}>
                <div style={{ fontFamily: "'VT323', monospace", fontSize: 16, color: "#000", marginBottom: 4 }}>
                  User name:
                </div>
                <input
                  value={username}
              ...
              {error && (
                <div style={{ fontFamily: "'VT323', monospace", fontSize: 15, color: "#CC0000", marginBottom: 10 }}>
                  ⚠ {error}
                </div>
              )}
              ...
              <div style={{ display: "flex", justifyContent: "flex-end", gap: 8 }}>
                <button
                  ...
                  style={{
                    ...
                    transform: btnPressed ? "translate(1px, 1px)" : "none",
                    minWidth: 80,
                    fontFamily: "'VT323', monospace",
                    fontSize: 17,
                  }}
...
const xpInputStyle: React.CSSProperties = {
  width: "100%",
